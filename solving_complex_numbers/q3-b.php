...
<html lang="en">
 ...
 <body>
   ...
   *Please note that the value of b is always 1 <br/>
  ...
  <form method="post">
   ...
   if($_SERVER["REQUEST_METHOD"] == "POST"){
	   ...
	   // Step 2 - Print z^n
	   echo "z<sup>" . $n . "</sup> = cos 1/2&pi; + <span class='i'>i</span> sin 1/2&pi;";
		echo "<br/>";
	   
	   // Step 3 - Express z
	   if(is_int($mag) && $mag == 1){
		   echo "z = [cos (1/2&pi; + 2k&pi;) + <span class='i'>i</span> sin(1/2&pi; + 2k&pi;)]<sup>1/" . $n . "</sup>, k = 0";
	   }
	   ...
	   for($rows=0; $rows<$n; $rows++){
		   ...
		   if($rows == $row_black){
			   echo "<span class='z-black'>z =</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;";
				echo "cos 1/" . $n . " (1/2&pi; + 2(" . $rows . ")&pi;)";
				echo "&nbsp;+&nbsp;";
				echo "<span class='i'>i</span> sin 1/" . $n . " (1/2&pi; + 2(" . $rows . ")&pi;) ";
				echo ", k = " . $rows;
			   echo "<br/>";
		   }else{
